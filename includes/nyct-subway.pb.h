...
#ifndef PROTOBUF_INCLUDED_nyct_2dsubway_2eproto
#define PROTOBUF_INCLUDED_nyct_2dsubway_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_nyct_2dsubway_2eproto 
...
class TripReplacementPeriod : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:TripReplacementPeriod) */ {
 public:
  ...
  inline TripReplacementPeriod* New() const final {
    return CreateMaybeMessage<TripReplacementPeriod>(NULL);
  }

  TripReplacementPeriod* New(::google::protobuf::Arena* arena) const final {
...
class NyctFeedHeader : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:NyctFeedHeader) */ {
 public:
  ...
  inline NyctFeedHeader* New() const final {
    return CreateMaybeMessage<NyctFeedHeader>(NULL);
  }

  NyctFeedHeader* New(::google::protobuf::Arena* arena) const final {
...
class NyctTripDescriptor : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:NyctTripDescriptor) */ {
 public:
  ...
  inline NyctTripDescriptor* New() const final {
    return CreateMaybeMessage<NyctTripDescriptor>(NULL);
  }

  NyctTripDescriptor* New(::google::protobuf::Arena* arena) const final {
...
class NyctStopTimeUpdate : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:NyctStopTimeUpdate) */ {
 public:
  ...
  inline NyctStopTimeUpdate* New() const final {
    return CreateMaybeMessage<NyctStopTimeUpdate>(NULL);
  }

  NyctStopTimeUpdate* New(::google::protobuf::Arena* arena) const final {
...
inline ::std::string* NyctFeedHeader::release_nyct_subway_version() {
  ...
  clear_has_nyct_subway_version();
  return nyct_subway_version_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* NyctTripDescriptor::release_train_id() {
  ...
  clear_has_train_id();
  return train_id_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* NyctStopTimeUpdate::release_scheduled_track() {
  ...
  clear_has_scheduled_track();
  return scheduled_track_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* NyctStopTimeUpdate::release_actual_track() {
  ...
  clear_has_actual_track();
  return actual_track_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
#endif  // PROTOBUF_INCLUDED_nyct_2dsubway_2eproto
